...
| プレイヤー能力の現在仕様 / HP / 残回数 / 装備 | `saves/<session_name>/current/player.md` |
...
| 敵勢力設計 / 妲己型条件 / 勢力マップ | `saves/<session_name>/design/villain_design.md` |
...
2. 必要なら `design/villain_design.md` から勢力浮上条件を取る
3. エピソードタイプを決める
