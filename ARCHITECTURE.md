...
| Story Design Layer | 物語が霧にならないための最小背骨と組織キャスト設計 | `saves/session_XXX/design/story_spine.md`（案）, `saves/session_XXX/design/villain_design.md` |
...
1. Organization Cast Pre-Generation
2. Minimal Story Spine
