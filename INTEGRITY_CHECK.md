...
```bash
rg -n "現在フェーズ|Appearance Profile|Ability Constraint Profile|Work Profile|Life Base|Equipment|Organization Doctrine|Heroine Crisis Role|Anti-Meta|Knowledge Boundary|AFFINITY|bond|直近の後遺症|勢力クロック|転機候補|リアルタイム発見|プレイヤー観測メモ" \
  saves/<session_name>/current \
