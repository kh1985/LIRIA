...
- new 時は Q6 後の `Initial Story Assembly` と `Light Story Reference Pass` により、`design/story_reference.md`, `design/story_spine.md`, `design/organization_cast.md`, `current/case.md` が初回シーン前に短く初期化されているべきだ
