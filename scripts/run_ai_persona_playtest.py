    ...
    *,
    ...
    return "\n".join(
        [
            ...
            "- 最初のきっかけは、Q1-Q6 / Q1.5 / Q5.5 に相当する `生活導線 + 初期圧 + 小物や信号 + 社会の窓口 + ヒロイン/NPCの利害` から新しく合成する。",
            ...
            "- 迷いやすい判断点のGM応答では、必要に応じて `1-3` の自然な候補と `4. 自由入力` を出す。1は安全/生活、2は関係/本音、3は事件/能力/リスク。毎ターンは出さない。",
